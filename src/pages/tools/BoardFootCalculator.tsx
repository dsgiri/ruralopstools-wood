        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <a href="https://ruralutilitycost.com" target="_blank" rel="noopener noreferrer" className="block border border-[#DCD3C7] p-4 rounded-sm bg-white hover:border-[#5A4633] transition-colors group">
                <strong className="block text-[#42372E] group-hover:text-[#5A4633] transition-colors">Rural Utility Cost Platform</strong>
